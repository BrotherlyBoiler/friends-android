...
public class FriendsDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + Tables.FRIENDS + " ("
                         ...
                         + FriendsContract.Columns.FRIENDS_NAME + " TEXT NOT NULL,"
                         + FriendsContract.Columns.FRIENDS_EMAIL + " TEXT NOT NULL,"
                         + FriendsContract.Columns.FRIENDS_PHONE + " TEXT NOT NULL)");
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (version == 1) {
            // Add extra fields to the database without deleting existing data
            version = 2;
        }
