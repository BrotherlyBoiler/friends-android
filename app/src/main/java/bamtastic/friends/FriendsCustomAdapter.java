    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(FriendsContract.Columns.FRIENDS_ID, String.valueOf(_id));
                intent.putExtra(FriendsContract.Columns.FRIENDS_NAME, name);
                intent.putExtra(FriendsContract.Columns.FRIENDS_PHONE, phone);
                intent.putExtra(FriendsContract.Columns.FRIENDS_EMAIL, email);
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                args.putInt(FriendsContract.Columns.FRIENDS_ID, _id);
                args.putString(FriendsContract.Columns.FRIENDS_NAME, name);
